...
//
// VIKTIGT: { fullResults: true } gör att Neon returnerar { rows, fields, rowCount }
// istället för att bara resolva till en ren array av rader. Utan detta kraschar
// varje "const { rows } = await sql\`...\`" i övriga filer, eftersom rows då
// blir undefined (man destrukturerar ett fält som inte finns på en array).
